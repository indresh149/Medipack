...
const OneWeekScannedOut = () => {
  ...
  const loadParcels = async () => {
    try {
      let fetchedParcelsScanOutWithOtp: Parcel[] =
        await fetchParcelsFromLastWeek(4);
      let fetchedParcelsScanOutWithId: Parcel[] =
        await fetchParcelsFromLastWeek(5);
      let fetchedParcels: Parcel[] = [
        ...fetchedParcelsScanOutWithOtp,
        ...fetchedParcelsScanOutWithId,
      ];
